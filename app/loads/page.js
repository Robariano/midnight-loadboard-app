...
export default function Loads() {
  ...
  return (
        ...
        <h1 style={{ color: "#fff", margin: 0 }}>Available Loads</h1>
{me !== undefined && (
            <p style={{ color: "#888", fontSize: 13, margin: 0 }}>
{me ? (
                <>Logged in as <a href="/account" style={{ color: "#5c5cff" }}>{me.company_name}</a></>
              ) : (
                              <a href="/login?next=/loads" style={{ color: "#5c5cff" }}>Log in to claim loads</a>
            )}
</p>
        )}
</div>
