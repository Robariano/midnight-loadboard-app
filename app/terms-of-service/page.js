export default function TermsOfService() {
  return (
    <div>
      ...
      <h2 style={{ color: "#fff", fontSize: 18, marginTop: 24 }}>The service</h2>
      <p style={{ color: "#e0e0e0", lineHeight: 1.6 }}>
      ...
      <h2 style={{ color: "#fff", fontSize: 18, marginTop: 24 }}>SMS notifications</h2>
      <p style={{ color: "#e0e0e0", lineHeight: 1.6 }}>
      ...
      <h2 style={{ color: "#fff", fontSize: 18, marginTop: 24 }}>No warranty</h2>
      <p style={{ color: "#e0e0e0", lineHeight: 1.6 }}>
